...
Social networks are clearly not well-mixed since individuals in those networks
can only learn from network neighbors. But what is the distribution,
exactly, of $\Pr(L,A)$? For fun let's consider an anachronistic example where 
