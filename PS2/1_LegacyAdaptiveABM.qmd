...
In this problem, create three time series plots of adoption of the
adaptive behavior over time for both the continuous-time and agent-based
models, for a total of six time series. \
\
Hypothesize first how you think different combinations of adoption and
drop rates will affect the shape of the adoption curves. Also explain
your expectations about how the continuous-time and agent-based models
will be similar or different.

Put your code with resulting plots below. After that, explain whether
